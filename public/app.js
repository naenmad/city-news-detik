...
// API Documentation Tab Functionality
function showApiVersion(version) {
    // Hide all tab contents
    document.querySelectorAll('.api-version-content').forEach(content => {
    ...
    const selectedContent = document.getElementById(`api-${version}`);
    if (selectedContent) {
